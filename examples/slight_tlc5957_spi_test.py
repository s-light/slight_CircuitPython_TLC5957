...
"""Simple & Minimallistic test for the TLC5957 library.

mainly to help to port to arduino.
"""
...
# 3MHz for the grayscale clock
gsclk = pulseio.PWMOut(
    board.D9, duty_cycle=(2 ** 15), frequency=(3 * 1000 * 1000))
...
while True:
    # this takes ~ 50ms
    pixels.show()
    # wait 80ms → this way we can capture a nice image on the oscilloscope
    time.sleep(0.08)
